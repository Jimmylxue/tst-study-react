...
// 父组件
function Board({ xIsNext, squares, onPlay, onRestart }:BoardProps) {
...
export default function Game() {
  ...
  const [winnerName, setWinnerName] = useState<string | null>(null); // 添加获胜者名称变量
  ...
  //  通用对话框
  const dialog = (title:string, diaFlag:string, content:string) => {
